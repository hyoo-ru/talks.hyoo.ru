...
(function ($) {
    ...
    __decorate([
        $.$mol_mem
    ], $hyoo_talks_message.prototype, "Person", null);
...
var $;
(function ($) {
    class $hyoo_talks_person_avatar extends $.$mol_image {
        person() {
...
(function ($) {
    ...
    __decorate([
        $.$mol_mem
    ], $hyoo_talks_message_bubble.prototype, "Text2", null);
    __decorate([
        $.$mol_mem
...
(function ($) {
    class $hyoo_talks_chat_page extends $.$mol_page {
        title() {
            return this.$.$mol_locale.text('$hyoo_talks_chat_page_title');
        }
        messages(val) {
            if (val !== undefined)
                return val;
    ...
    __decorate([
        $.$mol_mem
    ], $hyoo_talks_chat_page.prototype, "Store", null);
    __decorate([
        $.$mol_mem_key
...
(function ($) {
    ...
    (function ($$) {
        class $hyoo_talks_chat_page extends $.$hyoo_talks_chat_page {
            messages(next) {
                return this.Store().value('chat/messages', next) ?? [];
            }
            Message(id) {

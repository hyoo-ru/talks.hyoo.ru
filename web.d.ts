...
declare namespace $ {
	...
	type $mol_view__title__CVDPGBV2 = $mol_type_enforce<
		string
		,
...
declare namespace $ {
	...
	type $mol_svg_path__geometry__XECNYZLW = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_speck__value__06LLZODH = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_pop_bubble__align__2ITBACS1 = $mol_type_enforce<
		ReturnType< $mol_pop['align'] >
		,
		ReturnType< $mol_pop_bubble['align'] >
	>
	type $mol_pop_bubble__content__PVH55BNN = $mol_type_enforce<
		ReturnType< $mol_pop['bubble_content'] >
		,
		ReturnType< $mol_pop_bubble['content'] >
	>
	type $mol_pop_bubble__height_max__F45B5MMU = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_hotkey__mod_ctrl__CBQS53SU = $mol_type_enforce<
		ReturnType< $mol_string['submit_with_ctrl'] >
		,
		ReturnType< $mol_hotkey['mod_ctrl'] >
	>
	type $mol_hotkey__key__FEIB05MK = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_view__style__IG524YGZ = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__style__WXK2KEFZ = $mol_type_enforce<
		({ 
...
declare namespace $ {
	...
	type $mol_paragraph__sub__GYAEOV34 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_paragraph['sub'] >
	>
	type $mol_paragraph__sub__ISOBC0F5 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_paragraph['sub'] >
	>
...
declare namespace $ {
	...
	type $mol_hotkey__key__JGCBSGL7 = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_hotkey['key'] >
	>
	type $mol_nav__keys_y__T0WAT62I = $mol_type_enforce<
		ReturnType< $mol_search['nav_components'] >
		,
		ReturnType< $mol_nav['keys_y'] >
	>
	type $mol_nav__current_y__7PY9S2XH = $mol_type_enforce<
		ReturnType< $mol_search['nav_focused'] >
		,
		ReturnType< $mol_nav['current_y'] >
	>
	type $mol_string__value__JBG1UB51 = $mol_type_enforce<
		ReturnType< $mol_search['query'] >
		,
		ReturnType< $mol_string['value'] >
	>
	type $mol_string__hint__MI3VKYKF = $mol_type_enforce<
		ReturnType< $mol_search['hint'] >
		,
		ReturnType< $mol_string['hint'] >
	>
	type $mol_string__submit__LFRAN0IV = $mol_type_enforce<
		ReturnType< $mol_search['submit'] >
		,
		ReturnType< $mol_string['submit'] >
	>
	type $mol_string__enabled__VZPCG6Q1 = $mol_type_enforce<
		ReturnType< $mol_search['enabled'] >
		,
		ReturnType< $mol_string['enabled'] >
	>
	type $mol_string__keyboard__GFJ5O6JN = $mol_type_enforce<
		ReturnType< $mol_search['keyboard'] >
		,
		ReturnType< $mol_string['keyboard'] >
	>
	type $mol_string__enter__6FNER708 = $mol_type_enforce<
		ReturnType< $mol_search['enter'] >
		,
		ReturnType< $mol_string['enter'] >
	>
	type $mol_button_minor__hint__4UPANX33 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['hint'] >
	>
	type $mol_button_minor__click__ZU8FRE8V = $mol_type_enforce<
		ReturnType< $mol_search['clear'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__sub__Q8OWYORT = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	type $mol_list__rows__6QAQ9ACV = $mol_type_enforce<
		ReturnType< $mol_search['menu_items'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_dimmer__haystack__JNN47CXS = $mol_type_enforce<
		ReturnType< $mol_search['suggest_label'] >
		,
		ReturnType< $mol_dimmer['haystack'] >
	>
	type $mol_dimmer__needle__G4U6E8IY = $mol_type_enforce<
		ReturnType< $mol_search['query'] >
		,
		ReturnType< $mol_dimmer['needle'] >
	>
	type $mol_search_plugins__KD0NR85V = $mol_type_enforce<
		ReturnType< $mol_pop['plugins'] >[number]
		,
		$mol_plugin
	>
	type $mol_view__sub__XY4KFKHP = $mol_type_enforce<
		ReturnType< $mol_search['anchor_content'] >
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_button_minor__click__X5DP3TEW = $mol_type_enforce<
		ReturnType< $mol_search['suggest_select'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__sub__B897Z8YK = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__sub__AILTGQAW = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
...
declare namespace $ {
	...
	type $mol_check__minimal_width__3B884E4U = $mol_type_enforce<
		number
		,
		ReturnType< $mol_check['minimal_width'] >
	>
	type $mol_check__minimal_height__EVC7ZE4L = $mol_type_enforce<
		number
		,
		ReturnType< $mol_check['minimal_height'] >
	>
	type $mol_check__enabled__KFIBWGO4 = $mol_type_enforce<
		ReturnType< $mol_pick['trigger_enabled'] >
		,
		ReturnType< $mol_check['enabled'] >
	>
	type $mol_check__checked__H056VZP3 = $mol_type_enforce<
		ReturnType< $mol_pick['showed'] >
		,
		ReturnType< $mol_check['checked'] >
	>
	type $mol_check__clicks__B431CEYJ = $mol_type_enforce<
		ReturnType< $mol_pick['clicks'] >
		,
		ReturnType< $mol_check['clicks'] >
	>
	type $mol_check__sub__LR3876VM = $mol_type_enforce<
		ReturnType< $mol_pick['trigger_content'] >
		,
		ReturnType< $mol_check['sub'] >
	>
	type $mol_check__hint__WYFIAF7U = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_dimmer__haystack__J0H9EQ0H = $mol_type_enforce<
		ReturnType< $mol_select['option_label'] >
		,
		ReturnType< $mol_dimmer['haystack'] >
	>
	type $mol_dimmer__needle__S8GLJI93 = $mol_type_enforce<
		ReturnType< $mol_select['filter_pattern'] >
		,
		ReturnType< $mol_dimmer['needle'] >
	>
	type $mol_nav__keys_y__VOLYLJPZ = $mol_type_enforce<
		ReturnType< $mol_select['nav_components'] >
		,
		ReturnType< $mol_nav['keys_y'] >
	>
	type $mol_nav__current_y__EEHXRKUZ = $mol_type_enforce<
		ReturnType< $mol_select['option_focused'] >
		,
		ReturnType< $mol_nav['current_y'] >
	>
	type $mol_nav__cycle__REWRG5XR = $mol_type_enforce<
		ReturnType< $mol_select['nav_cycle'] >
		,
		ReturnType< $mol_nav['cycle'] >
	>
	type $mol_list__rows__2I3380K8 = $mol_type_enforce<
		ReturnType< $mol_select['menu_content'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_scroll__sub__7WNSA36R = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_scroll['sub'] >
	>
	type $mol_button_minor__event_click__28V187LD = $mol_type_enforce<
		ReturnType< $mol_select['event_select'] >
		,
		ReturnType< $mol_button_minor['event_click'] >
	>
	type $mol_button_minor__sub__QGCEKTL9 = $mol_type_enforce<
		ReturnType< $mol_select['option_content'] >
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	type $mol_view__sub__PEQNI9Z2 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_search__query__55F7O6R8 = $mol_type_enforce<
		ReturnType< $mol_select['filter_pattern'] >
		,
		ReturnType< $mol_search['query'] >
	>
	type $mol_search__hint__HR1W3V3L = $mol_type_enforce<
		ReturnType< $mol_select['filter_hint'] >
		,
		ReturnType< $mol_search['hint'] >
	>
	type $mol_search__submit__29DF7BDN = $mol_type_enforce<
		ReturnType< $mol_select['submit'] >
		,
		ReturnType< $mol_search['submit'] >
	>
	type $mol_search__enabled__6ZG1MBFD = $mol_type_enforce<
...
declare namespace $ {
	...
	type $hyoo_sync_online_master_cursor__XNHC9RYG = $mol_type_enforce<
		Parameters< $hyoo_sync_online['master_cursor'] >[0]
		,
		Parameters< ReturnType< $hyoo_sync_online['yard'] >['master_cursor'] >[0]
	>
	type $mol_avatar__id__4R89CL74 = $mol_type_enforce<
		ReturnType< $hyoo_sync_online['master_id'] >
		,
		ReturnType< $mol_avatar['id'] >
	>
	type $mol_avatar__id__FOVJMDEY = $mol_type_enforce<
		ReturnType< $hyoo_sync_online['master_link'] >
		,
		ReturnType< $mol_avatar['id'] >
	>
	type $mol_link__uri__OJB64UUQ = $mol_type_enforce<
		ReturnType< $hyoo_sync_online['master_link'] >
		,
		ReturnType< $mol_link['uri'] >
	>
	type $mol_link__sub__QJ440JZV = $mol_type_enforce<
		ReturnType< $hyoo_sync_online['link_content'] >
		,
		ReturnType< $mol_link['sub'] >
	>
	type $mol_link__hint__JWXNQSLH = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__dom_name__AHR5YGVP = $mol_type_enforce<
		string
		,
		ReturnType< $mol_view['dom_name'] >
	>
	type $mol_view__sub__P4ZFDP2K = $mol_type_enforce<
		ReturnType< $mol_page['title_content'] >
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub__5XKAC3TW = $mol_type_enforce<
		ReturnType< $mol_page['tools'] >
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__minimal_height__R4JXIWD8 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_view['minimal_height'] >
	>
	type $mol_view__dom_name__09F5YDNQ = $mol_type_enforce<
		string
		,
		ReturnType< $mol_view['dom_name'] >
	>
	type $mol_view__sub__07LXVG49 = $mol_type_enforce<
		ReturnType< $mol_page['head'] >
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_page_body_scroll_top__DDGATSND = $mol_type_enforce<
		Parameters< $mol_page['body_scroll_top'] >[0]
		,
		Parameters< ReturnType< $mol_page['Body'] >['scroll_top'] >[0]
	>
	type $mol_view__sub__FSQJDJ34 = $mol_type_enforce<
		ReturnType< $mol_page['body'] >
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_scroll__sub__9ST7ZY29 = $mol_type_enforce<
		ReturnType< $mol_page['body_content'] >
		,
		ReturnType< $mol_scroll['sub'] >
	>
	type $mol_view__dom_name__N7RRS85U = $mol_type_enforce<
		string
		,
		ReturnType< $mol_view['dom_name'] >
	>
	type $mol_view__sub__RY737SQM = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__minimal_height__CEOMDNH9 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_view['minimal_height'] >
	>
	type $mol_view__sub__ZPE3FXUI = $mol_type_enforce<
		ReturnType< $mol_labeler['label'] >
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__minimal_height__KZY5MO5D = $mol_type_enforce<
		number
		,
		ReturnType< $mol_view['minimal_height'] >
	>
	type $mol_view__sub__6I0VQH12 = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__sub__IQSN65U5 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
...
declare namespace $ {
	...
	type $mol_list__sub__HKMRPOLL = $mol_type_enforce<
		ReturnType< $mol_form['body'] >
		,
		ReturnType< $mol_list['sub'] >
	>
	type $mol_row__sub__3QEG8HOF = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_string__value__T8HT71ZT = $mol_type_enforce<
		ReturnType< $hyoo_talks_person_settings['name'] >
		,
		ReturnType< $mol_string['value'] >
	>
	type $mol_form_field__name__EV55IC54 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_form_field['name'] >
	>
	type $mol_form_field__control__W2ZZJPU0 = $mol_type_enforce<
		ReturnType< $hyoo_talks_person_settings['Name'] >
		,
		ReturnType< $mol_form_field['control'] >
	>
	type $mol_string__value__DQKUQ3MZ = $mol_type_enforce<
		ReturnType< $hyoo_talks_person_settings['background'] >
		,
		ReturnType< $mol_string['value'] >
	>
	type $mol_form_field__name__DQMMSH6H = $mol_type_enforce<
		string
		,
		ReturnType< $mol_form_field['name'] >
	>
	type $mol_form_field__control__LIZ1PXO8 = $mol_type_enforce<
		ReturnType< $hyoo_talks_person_settings['Background'] >
		,
		ReturnType< $mol_form_field['control'] >
	>
	type $mol_form__form_fields__3EX28YQH = $mol_type_enforce<
		readonly(any)[]
		,
...
declare namespace $ {
	...
	type $mol_button_minor__hint__WVS8UKUC = $mol_type_enforce<
		ReturnType< $mol_paginator['backward_hint'] >
		,
		ReturnType< $mol_button_minor['hint'] >
	>
	type $mol_button_minor__click__PQ1PYK4L = $mol_type_enforce<
		ReturnType< $mol_paginator['backward'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__sub__43KCYABT = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	type $mol_view__sub__CSB8FTQX = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_button_minor__hint__4TZST8CI = $mol_type_enforce<
		ReturnType< $mol_paginator['forward_hint'] >
		,
		ReturnType< $mol_button_minor['hint'] >
	>
	type $mol_button_minor__click__IU9SUIMC = $mol_type_enforce<
		ReturnType< $mol_paginator['forward'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__sub__6JFBFO3U = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
...
declare namespace $ {
	...
	type $mol_hotkey__key__U9HESRTT = $mol_type_enforce<
		...
		ReturnType< $mol_hotkey['key'] >
	>
	type $mol_hotkey__key__FUFH58AF = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_hotkey['key'] >
	>
	type $mol_paginator__value__Z9YQ7SAW = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_view__sub__LVO7AJE4 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_text_code_token__type__IRVT3X0J = $mol_type_enforce<
		ReturnType< $mol_text_code_row['token_type'] >
		,
		ReturnType< $mol_text_code_token['type'] >
	>
	type $mol_text_code_token__haystack__LA8PJM58 = $mol_type_enforce<
		ReturnType< $mol_text_code_row['token_text'] >
		,
		ReturnType< $mol_text_code_token['haystack'] >
	>
	type $mol_text_code_token__needle__Z7WWXETH = $mol_type_enforce<
		ReturnType< $mol_text_code_row['highlight'] >
		,
		ReturnType< $mol_text_code_token['needle'] >
	>
	type $mol_text_code_token_link__haystack__8MC93GKB = $mol_type_enforce<
		ReturnType< $mol_text_code_row['token_text'] >
		,
		ReturnType< $mol_text_code_token_link['haystack'] >
	>
	type $mol_text_code_token_link__needle__SJXOKLLM = $mol_type_enforce<
		ReturnType< $mol_text_code_row['highlight'] >
		,
		ReturnType< $mol_text_code_token_link['needle'] >
	>
	type $mol_text_code_token_link__uri__O891GQ3U = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_blob__2Y9VFN4A = $mol_type_enforce<
		[ readonly(BlobPart)[], ({ 
			'type': string,
		})  ]
		,
	...
	>
	type $mol_blob__B6EX0I8Z = $mol_type_enforce<
		[ readonly(BlobPart)[], ({ 
			'type': string,
		})  ]
		,
...
declare namespace $ {
	...
	type $mol_text_code_row__numb_showed__MQVTHSEE = $mol_type_enforce<
		ReturnType< $mol_text_code['sidebar_showed'] >
		,
		ReturnType< $mol_text_code_row['numb_showed'] >
	>
	type $mol_text_code_row__numb__AL7GW0FW = $mol_type_enforce<
		ReturnType< $mol_text_code['row_numb'] >
		,
		ReturnType< $mol_text_code_row['numb'] >
	>
	type $mol_text_code_row__text__UZ16BFQS = $mol_type_enforce<
		ReturnType< $mol_text_code['row_text'] >
		,
		ReturnType< $mol_text_code_row['text'] >
	>
	type $mol_text_code_row__syntax__30O8COUR = $mol_type_enforce<
		ReturnType< $mol_text_code['syntax'] >
		,
		ReturnType< $mol_text_code_row['syntax'] >
	>
	type $mol_text_code_row__uri_resolve__92RYYSYS = $mol_type_enforce<
		ReturnType< $mol_text_code['uri_resolve'] >
		,
		ReturnType< $mol_text_code_row['uri_resolve'] >
	>
	type $mol_text_code_row__highlight__YCCNQIS9 = $mol_type_enforce<
		ReturnType< $mol_text_code['highlight'] >
		,
		ReturnType< $mol_text_code_row['highlight'] >
	>
	type $mol_list__render_visible_only__BKHVZHM5 = $mol_type_enforce<
		ReturnType< $mol_text_code['render_visible_only'] >
		,
		ReturnType< $mol_list['render_visible_only'] >
	>
	type $mol_list__rows__UZO33M9N = $mol_type_enforce<
		ReturnType< $mol_text_code['rows'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_button_copy__hint__VYY6NSY6 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_copy['hint'] >
	>
	type $mol_button_copy__text__VC030CBY = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_textarea_edit__value__YGP4FQFJ = $mol_type_enforce<
		ReturnType< $mol_textarea['value'] >
		,
		ReturnType< $mol_textarea_edit['value'] >
	>
	type $mol_textarea_edit__hint__DNUGW3LG = $mol_type_enforce<
		ReturnType< $mol_textarea['hint'] >
		,
		ReturnType< $mol_textarea_edit['hint'] >
	>
	type $mol_textarea_edit__enabled__CAHMJVPK = $mol_type_enforce<
		ReturnType< $mol_textarea['enabled'] >
		,
		ReturnType< $mol_textarea_edit['enabled'] >
	>
	type $mol_textarea_edit__spellcheck__Z1LKVLMP = $mol_type_enforce<
		ReturnType< $mol_textarea['spellcheck'] >
		,
		ReturnType< $mol_textarea_edit['spellcheck'] >
	>
	type $mol_textarea_edit__length_max__57MLKIBI = $mol_type_enforce<
		ReturnType< $mol_textarea['length_max'] >
		,
		ReturnType< $mol_textarea_edit['length_max'] >
	>
	type $mol_textarea_edit__selection__8SUMBR7O = $mol_type_enforce<
		ReturnType< $mol_textarea['selection'] >
		,
		ReturnType< $mol_textarea_edit['selection'] >
	>
	type $mol_textarea_edit__submit__DFXA0OVW = $mol_type_enforce<
		ReturnType< $mol_textarea['submit'] >
		,
		ReturnType< $mol_textarea_edit['submit'] >
	>
	type $mol_textarea_edit__submit_with_ctrl__0NR3761A = $mol_type_enforce<
		ReturnType< $mol_textarea['submit_with_ctrl'] >
		,
		ReturnType< $mol_textarea_edit['submit_with_ctrl'] >
	>
	type $mol_text_code__text__2KLCLPTU = $mol_type_enforce<
		ReturnType< $mol_textarea['value'] >
		,
		ReturnType< $mol_text_code['text'] >
	>
	type $mol_text_code__render_visible_only__FW7WPLGH = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_text_code['render_visible_only'] >
	>
	type $mol_text_code__row_numb__3N1S9652 = $mol_type_enforce<
		ReturnType< $mol_textarea['row_numb'] >
		,
		ReturnType< $mol_text_code['row_numb'] >
	>
	type $mol_text_code__sidebar_showed__LC2CAVC8 = $mol_type_enforce<
		ReturnType< $mol_textarea['sidebar_showed'] >
		,
		ReturnType< $mol_text_code['sidebar_showed'] >
	>
	type $mol_text_code__highlight__QK3RLRSD = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_avatar__id__G1Z7DDZ3 = $mol_type_enforce<
		ReturnType< $hyoo_talks_person_avatar['id'] >
		,
		ReturnType< $mol_avatar['id'] >
	>
	type $mol_paragraph__sub__XVXCVGET = $mol_type_enforce<
...
declare namespace $ {
	...
	type $mol_link__uri__6LVP91QI = $mol_type_enforce<
		ReturnType< $mol_embed_native['uri'] >
		,
		ReturnType< $mol_link['uri'] >
	>
	type $mol_link__sub__R11IY3OP = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_link['sub'] >
	>
...
declare namespace $ {
	...
	type $hyoo_talks_person_avatar__person__K7VGPX1Q = $mol_type_enforce<
		ReturnType< $hyoo_talks_message_bubble['author'] >
		,
		ReturnType< $hyoo_talks_person_avatar['person'] >
	>
	type $mol_paragraph__sub__C56KRD8T = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_paragraph['sub'] >
	>
	type $mol_view__sub__JOUE7DAO = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_textarea__value__EIRUATD5 = $mol_type_enforce<
		ReturnType< $hyoo_talks_message_bubble['text'] >
		,
		ReturnType< $mol_textarea['value'] >
	>
	type $mol_textarea__enabled__VZ0H9WNR = $mol_type_enforce<
		ReturnType< $hyoo_talks_message_bubble['editable'] >
		,
		ReturnType< $mol_textarea['enabled'] >
	>
	type $mol_textarea__highlight__1S0KA3A6 = $mol_type_enforce<
		ReturnType< $hyoo_talks_message_bubble['highlight'] >
		,
		ReturnType< $mol_textarea['highlight'] >
	>
	type $mol_view__sub__EIQESUN5 = $mol_type_enforce<
		ReturnType< $hyoo_talks_message_bubble['previews'] >
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_embed_native__uri__C4D6O0L2 = $mol_type_enforce<
		ReturnType< $hyoo_talks_message_bubble['preview_uri'] >
		,
		ReturnType< $mol_embed_native['uri'] >
	>
	type $mol_check__title__VR9FSWIH = $mol_type_enforce<
		ReturnType< $hyoo_talks_message_bubble['peek_label'] >
		,
		ReturnType< $mol_check['title'] >
	>
	type $mol_check__checked__9C2M8LJC = $mol_type_enforce<
		ReturnType< $hyoo_talks_message_bubble['peek'] >
		,
		ReturnType< $mol_check['checked'] >
	>
	type $mol_link__uri__1R87K57W = $mol_type_enforce<
		ReturnType< $hyoo_talks_message_bubble['preview_uri'] >
		,
		ReturnType< $mol_link['uri'] >
	>
	type $mol_link__sub__V9T8QT4M = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_link['sub'] >
	>
...
declare namespace $ {
	...
	type $mol_button_download__hint__A660FD18 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_download['hint'] >
	>
	type $mol_button_download__file_name__LGKH31YO = $mol_type_enforce<
		ReturnType< $hyoo_talks_chat_page['dump_name'] >
		,
		ReturnType< $mol_button_download['file_name'] >
	>
	type $mol_button_download__blob__WJ92HUBN = $mol_type_enforce<
		ReturnType< $hyoo_talks_chat_page['dump_blob'] >
		,
		ReturnType< $mol_button_download['blob'] >
	>
	type $mol_check_icon__hint__XSKS7U8S = $mol_type_enforce<
		string
		,
		ReturnType< $mol_check_icon['hint'] >
	>
	type $mol_check_icon__Icon__6XKZ1VB2 = $mol_type_enforce<
		ReturnType< $hyoo_talks_chat_page['Joined_icon'] >
		,
		ReturnType< $mol_check_icon['Icon'] >
	>
	type $mol_check_icon__checked__XG4IC7I7 = $mol_type_enforce<
		ReturnType< $hyoo_talks_chat_page['joined'] >
		,
		ReturnType< $mol_check_icon['checked'] >
	>
	type $mol_check_icon__hint__NWGMNIPS = $mol_type_enforce<
		string
		,
		ReturnType< $mol_check_icon['hint'] >
	>
	type $mol_check_icon__Icon__GT32B6CG = $mol_type_enforce<
		ReturnType< $hyoo_talks_chat_page['Search_toggle_icon'] >
		,
		ReturnType< $mol_check_icon['Icon'] >
	>
	type $mol_check_icon__checked__7JL6Z191 = $mol_type_enforce<
		ReturnType< $hyoo_talks_chat_page['search_enabled'] >
		,
		ReturnType< $mol_check_icon['checked'] >
	>
	type $mol_search_jumper__query__C8EVKWSY = $mol_type_enforce<
		ReturnType< $hyoo_talks_chat_page['search'] >
		,
		ReturnType< $mol_search_jumper['query'] >
	>
	type $mol_search_jumper__Root__MH4KX6CZ = $mol_type_enforce<
		ReturnType< $hyoo_talks_chat_page['Body'] >
		,
		ReturnType< $mol_search_jumper['Root'] >
	>
	type $mol_search_jumper__escape__109SKWS4 = $mol_type_enforce<
		ReturnType< $hyoo_talks_chat_page['search_end'] >
		,
		ReturnType< $mol_search_jumper['escape'] >
	>
	type $mol_list__rows__1SNWU575 = $mol_type_enforce<
		ReturnType< $hyoo_talks_chat_page['bubbles'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_textarea__hint__NZEBDN5G = $mol_type_enforce<
		string
		,
		ReturnType< $mol_textarea['hint'] >
	>
	type $mol_textarea__value__9AQ6UXEG = $mol_type_enforce<
		ReturnType< $hyoo_talks_chat_page['draft_text'] >
		,
		ReturnType< $mol_textarea['value'] >
	>
	type $mol_check_icon__Icon__TVKDMSFP = $mol_type_enforce<
		ReturnType< $hyoo_talks_chat_page['Speech_toggle_icon'] >
		,
		ReturnType< $mol_check_icon['Icon'] >
	>
	type $mol_check_icon__checked__Y01RIPUP = $mol_type_enforce<
		ReturnType< $hyoo_talks_chat_page['hearing'] >
		,
		ReturnType< $mol_check_icon['checked'] >
	>
	type $mol_button_minor__title__GOE9ANM4 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['title'] >
	>
	type $mol_button_minor__hint__AEG1HYZI = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['hint'] >
	>
	type $mol_button_minor__sub__BG9ZBN0J = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	type $mol_button_minor__click__CNUWZRWE = $mol_type_enforce<
		ReturnType< $hyoo_talks_chat_page['draft_send'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_hotkey__mod_ctrl__P02J058K = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_hotkey['mod_ctrl'] >
	>
	type $mol_hotkey__key__H2GHHGRM = $mol_type_enforce<
		({ 
		...
		ReturnType< $mol_hotkey['key'] >
	>
	type $mol_string__value__12K7Q7RH = $mol_type_enforce<
		ReturnType< $hyoo_talks_chat_page['title'] >
		,
		ReturnType< $mol_string['value'] >
	>
	type $mol_string__hint__7ADFZ8OE = $mol_type_enforce<
		string
		,
		ReturnType< $mol_string['hint'] >
	>
	type $hyoo_talks_message_bubble__minimal_height__ZD8PWA1E = $mol_type_enforce<
		number
		,
		ReturnType< $hyoo_talks_message_bubble['minimal_height'] >
	>
	type $hyoo_talks_message_bubble__message__0T1OMAPO = $mol_type_enforce<
		ReturnType< $hyoo_talks_chat_page['message'] >
		,
		ReturnType< $hyoo_talks_message_bubble['message'] >
	>
	type $hyoo_talks_message_bubble__highlight__ALBOXNSM = $mol_type_enforce<
		ReturnType< $hyoo_talks_chat_page['search'] >
		,
		ReturnType< $hyoo_talks_message_bubble['highlight'] >
	>
...
declare namespace $ {
	...
	type $mol_button_minor__hint__3BBHWWMT = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['hint'] >
	>
	type $mol_button_minor__click__22MBMUM2 = $mol_type_enforce<
		ReturnType< $hyoo_talks['chat_new'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__sub__RKFLN2H6 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	type $mol_search__query__4EGLSLNT = $mol_type_enforce<
		ReturnType< $hyoo_talks['links_query'] >
		,
		ReturnType< $mol_search['query'] >
	>
	type $mol_list__rows__ZYHIEZQ4 = $mol_type_enforce<
		ReturnType< $hyoo_talks['links'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	type $hyoo_sync_online__yard__IR9YJTDZ = $mol_type_enforce<
		ReturnType< $hyoo_talks['yard'] >
		,
		ReturnType< $hyoo_sync_online['yard'] >
	>
	type $mol_link_source__uri__JCBLF9CY = $mol_type_enforce<
		string
		,
		ReturnType< $mol_link_source['uri'] >
	>
	type $mol_link__arg__V3KTOLV1 = $mol_type_enforce<
		({ 
			'settings': string,
		}) 
		,
	...
	>
	type $mol_link__hint__3VSHECN0 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_link['hint'] >
	>
	type $mol_link__sub__6A8E2O45 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_link['sub'] >
	>
	type $mol_link__arg__4TMOEZTO = $mol_type_enforce<
		({ 
			'settings': any,
		}) 
		,
		ReturnType< $mol_link['arg'] >
	>
	type $mol_link__sub__9N4RVDSF = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_link['sub'] >
	>
	type $mol_link__arg__IYJ1NAOX = $mol_type_enforce<
		({ 
			'chat': any,
		}) 
		,
		ReturnType< $mol_link['arg'] >
	>
	type $mol_link__sub__JZ20BNRG = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_link['sub'] >
	>
	type $mol_page__title__HV7A2WFB = $mol_type_enforce<
		string
		,
		ReturnType< $mol_page['title'] >
	>
	type $mol_page__tools__FAEN9O16 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_page['tools'] >
	>
	type $mol_page__body__3LW12KIP = $mol_type_enforce<
		ReturnType< $hyoo_talks['roster_body'] >
		,
		ReturnType< $mol_page['body'] >
	>
	type $mol_page__foot__DLHKPRK2 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_page['foot'] >
	>
	type $hyoo_talks_person_settings__person__R47O3Q41 = $mol_type_enforce<
		ReturnType< $hyoo_talks['User'] >
		,
		ReturnType< $hyoo_talks_person_settings['person'] >
	>
	type $hyoo_talks_person_settings__tools__V3S341O9 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $hyoo_talks_person_settings['tools'] >
	>
	type $hyoo_talks_chat_page__chat__Z0NX4LO9 = $mol_type_enforce<
		ReturnType< $hyoo_talks['chat'] >
		,
		ReturnType< $hyoo_talks_chat_page['chat'] >
	>
	type $hyoo_talks_chat_page__embed__Q2DUSBO7 = $mol_type_enforce<
		ReturnType< $hyoo_talks['embed'] >
		,
		ReturnType< $hyoo_talks_chat_page['embed'] >
	>
	type $hyoo_talks_chat_page__Close__5A7U4JGK = $mol_type_enforce<
		ReturnType< $hyoo_talks['Chat_close'] >
		,
		ReturnType< $hyoo_talks_chat_page['Close'] >
	>
	type $mol_speck__value__7XPF5ISJ = $mol_type_enforce<
		ReturnType< $hyoo_talks['chat_unread_count'] >
		,
		ReturnType< $mol_speck['value'] >
	>
	type $mol_dimmer__haystack__ESSR3J99 = $mol_type_enforce<
		ReturnType< $hyoo_talks['chat_title'] >
		,
		ReturnType< $mol_dimmer['haystack'] >
	>
	type $mol_dimmer__needle__2P9S8IWS = $mol_type_enforce<
		ReturnType< $hyoo_talks['links_query'] >
		,
		ReturnType< $mol_dimmer['needle'] >
	>
	type $mol_link__arg__7BJZPGMB = $mol_type_enforce<
		ReturnType< $hyoo_talks['chat_arg'] >
		,
		ReturnType< $mol_link['arg'] >
	>
	type $mol_link__sub__ZAJGK3R3 = $mol_type_enforce<
